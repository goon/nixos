...
>
> The location of the flake can be modified inside of `hosts/vars.nix` alongside your `username`. **Forgetting to update these values will result in a broken configuration.**
